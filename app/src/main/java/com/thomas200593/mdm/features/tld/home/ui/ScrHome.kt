...
import com.thomas200593.mdm.core.ui.common.anim.SlideDownFadeAnim
                ...
                content = {
                    Row(
                        ...
                        content = {
                            ...
                            UiText(
                                text = "User Name", type = TextType.TITLE_MD, modifier = Modifier.weight(1f),
                                maxLines = 1, overflow = TextOverflow.Ellipsis
                            )
                            IconButton (
                                onClick = { expanded = expanded.not() },
                                content = {
                                    if(expanded) Icon(Icons.Default.ExpandLess, null)
                    ...
                    SlideDownFadeAnim(
                        ...
                        content = {
                            Column {
                                HorizontalDivider()
                                Row (modifier = Modifier.fillMaxWidth().padding(Constants.Dimens.dp8)) {
                                    Column {
                                        //Icons
                                        UiText("Icons")
                                    }
...
@Preview @Composable private fun Preview() = SectionContent()