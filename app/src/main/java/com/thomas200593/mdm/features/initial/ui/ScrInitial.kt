...
private fun ScrInitial(
    scrGraph: ScrGraphs.Initial, componentsState: ComponentsState, onNavToOnboarding: () -> Unit,
    onNavToInitialization: () -> Unit, onNavToAuth: () -> Unit
...
private fun ScreenContent(
    components: ComponentsState.Loaded, onNavToOnboarding: () -> Unit, onNavToInitialization: () -> Unit,
    onNavToAuth: () -> Unit
